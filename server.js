...
// Health
app.get('/api/health',(q,r)=>r.json({status:'online',v:'7.0',dev:'NayonDev',hosts:{h1:!!H1,h2:!!H2,h3:!!H3,h4:!!H4,h5:!!H5,h6:!!H6},key:!!KEY,endpoints:102}));
...
app.listen(PORT,'0.0.0.0',()=>{console.log(`Server on ${PORT} | Nayon Alpha Signals v7.0 | 6 hosts | Key: ${KEY?'OK':'MISSING'}`)});
